...
const renderCradBebidas = () => {
    ...
    titleCard.textContent = 'Refrigerante em Lata'
    ...
    image.className = 'w-[175px] h-[152px] left-[10px] top-[26px] absolute';
    image.src = '../../images/refriLata.jpg';
